...
#ifndef INCL_FSYNCITEMLISTENER
#define INCL_FSYNCITEMLISTENER
...
/**
 * This class extends the SyncItemListener in order to be notified of the 
 * SyncItemEvents. It simply displays the sync messages on the shell.
 */
