 ...
 * NOTE: If other final status must be defined into custom implementation of
 * this class, remember to use value < 128; this means that the static data 
 * members. This restriction is due to the definition of the error codes 
 * provided into the listener that start from 128.
 */
