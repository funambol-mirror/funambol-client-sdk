...
/**
 * Overload serialization methods of Message to load the headers only. It is
 * used by RMSStore.getHeaders() to retrieve the list of headers.
 * 
 */
public class LightMessage extends Message {
    ...
    public void serialize(DataOutputStream dout) throws IOException {
        throw new IOException("Can't serialize a Light Message");
    }
