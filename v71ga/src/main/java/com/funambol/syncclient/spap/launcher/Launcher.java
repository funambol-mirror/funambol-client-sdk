...
/**
 * This interface models a generic class to be able to execute
 *  a specific programs category.
 *
 * @version  $Id: Launcher.java,v 1.3 2007-12-22 18:09:18 nichele Exp $
 *
 */
...
public interface Launcher {
    ...
    /**
     * Executes the specified <i>programName</i> in
     * the given <i>workingDirectory</i>.
     ...
     *
     * @throws AssetInstallationException if an error occurs during execution.
     */
