    ...
    public void test(int i) throws Throwable {
        switch(i) {
            ...
            case 12:
                ...
                break;
            case 13:
                testRestartServiceNoConnection();
                break;
            case 14:
                testRetryPeriod();
                break;
            case 15:
                testLongLatencyError();
                break;
            case 16:
                testFailingAuthentication1();
                break;
            case 17:
                testFailingAuthentication2();
                break;
            default:
                break;
        }
