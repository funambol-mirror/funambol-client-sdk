...
public abstract class BasicRobot extends Robot {
    ...
    public void checkLastSyncRequestedSyncMode(String source, int mode,
        ...
        assertTrue(sr != null, "source has not report associated");
    ...
    public void checkItemsCount(String sourceName, CheckSyncClient client,int count) throws Throwable {

        SyncSource source = client.getSyncSource(sourceName);
        ...
        while(item != null) {
            itemsCount++;
            source.setItemStatus(item.getKey(), 200);
    ...
    public abstract void waitForAuthToComplete(int minStart, int max,
            SyncMonitor syncMonitor) throws Throwable;
