...
public class SyncMonitorListener extends BasicSyncListener {
    ...
    private int receivingPhaseCounter = 0;
    private int sendingPhaseCounter   = 0;
    private SyncListener lis;
    private String  interruptOnPhase = null;
    private int     interruptOnPhaseNumber = -1;
    ...
    private void interruptSync(String reason) {
