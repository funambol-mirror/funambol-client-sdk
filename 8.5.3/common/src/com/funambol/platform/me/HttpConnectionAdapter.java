...
public class HttpConnectionAdapter {
    ...
    public static int HTTP_EXPECT_FAILED        = HttpConnection.HTTP_EXPECT_FAILED; // 417
    public static int HTTP_UNSUPPORTED_RANGE    = HttpConnection.HTTP_UNSUPPORTED_RANGE; // 416
