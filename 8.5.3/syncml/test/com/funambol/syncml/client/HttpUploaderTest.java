...
public class HttpUploaderTest extends TestCase {
    ...
    public void testCreateUploadUrl1() throws Throwable {
        ...
        TestHttpUploader uploader = new TestHttpUploader(config, "upload", "picture", null);
        String url = uploader.getUrl(null, "Picture0");
        assertTrue("http://my.funambol.com:9090/upload/picture?LUID=Picture0".equals(url));
    }

    public void testCreateUploadUrl2() throws Throwable {
        SyncConfig config = new SyncConfig();
        config.setSyncUrl("http://my.funambol.com:9090/sync");
        config.setUserName("test");
        config.setPassword("test");
        TestHttpUploader uploader = new TestHttpUploader(config, "upload", "picture", null);
        String url = uploader.getUrl("123456789", "Picture0");
        assertTrue("http://my.funambol.com:9090/upload/picture?LUID=Picture0;jsessionid=123456789".equals(url));
    }
    ...
    public void testUpload1() throws Throwable {
        ...
        int status = uploader.upload("Pic0.jpg", is, contentArr.length, null);
        ...
        String devId = (String)headers.get("deviceId");
        ...
        assertTrue(status == SyncMLStatus.SUCCESS);
    }
    ...
    public void testUpload2() throws Throwable {
        ...
        try {
            uploader.upload("Pic0.jpg", is, contentArr.length, null);
    ...
    private class TestConnectionManager extends ConnectionManager {
        ...
        public HttpConnectionAdapter openHttpConnection(String url) {
