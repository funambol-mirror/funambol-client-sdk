...
public class Calendar {
    ...
    public String toString() {
        ...
        sb.append("\nCalScale: " + (String)this.getCalScale().getPropertyValue());
        sb.append("\nMethod  : " + (String)this.getMethod().getPropertyValue());
        sb.append("\nProdId  : " + (String)this.getProdId().getPropertyValue());
        sb.append("\nVersion : " + (String)this.getVersion().getPropertyValue());
