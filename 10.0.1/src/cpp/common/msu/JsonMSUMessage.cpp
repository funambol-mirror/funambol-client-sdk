 ...
 */
bool JsonMSUMessage::parseFieldsToCheckValidity(const char* message)
{
    cJSON *root = NULL;
...
const char* JsonMSUMessage::formatFieldsToCheckValidity(const char *username, const char* password, bool prettyPrint)
{
    char* formattedObject = NULL;
    cJSON *root = NULL, 
    *data = NULL, 
    *user  = NULL;
    ...
    if (username) { // username should always be filled. The check is out of here
