...
public:
    ...
    EMSUStatusCode signupNoCaptcha(const char* username, const char* password, MSUDeviceInfo* deviceInfo);
     ...
     */
    EMSUStatusCode checkFieldsValidity(const char* username, const char* password);
