 ...
 *
 *
 * @version $Id: WBXMLSyncMLClient.java,v 1.3 2007-12-22 18:09:17 nichele Exp $
 *
 */
...
implements SyncMLClient {
    ...
    // Note charset is not used yet, because of WBXML.
    ...
    throws IOException {
        ...
        try {
            value = WBXMLTools.
                wbxmlToXml((sendMessage(WBXMLTools.toWBXML(msg))).getBytes());
        } catch (Exception e) {
