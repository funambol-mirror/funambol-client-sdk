 ...
 *
 *
 * @version $Id: SyncSourceEvent.java,v 1.3 2007-12-22 18:09:18 nichele Exp $
 */
public class SyncSourceEvent {
     ...
     * @param syncMode the type of the performed sync
     * @param date the date and time of the start or the end of the sync
     */
