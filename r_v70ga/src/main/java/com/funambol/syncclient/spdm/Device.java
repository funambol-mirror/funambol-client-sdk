 ...
 *
 *
 * @version $Id: Device.java,v 1.3 2007-12-22 18:09:17 nichele Exp $
 */
public interface Device {

    /**
     * Returns the base directory, so that the common parent directory of
     * the relative paths used in the device manager and other modules.
     * The way the current directory is detected is device specific.
     *
