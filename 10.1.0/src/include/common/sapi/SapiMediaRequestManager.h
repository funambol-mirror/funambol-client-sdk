...
class SapiMediaRequestManager
{
    ...
    public:
        ...
        virtual ESapiMediaRequestStatus getItemsChanges(ArrayList& newIDs, ArrayList& modIDs, 
		...
		virtual ESapiMediaRequestStatus login(const char* device_id, time_t* serverTime = NULL, unsigned long *expiretime = NULL, StringMap* sourcesStringMap = NULL, StringMap* propertyStringMap = NULL);
