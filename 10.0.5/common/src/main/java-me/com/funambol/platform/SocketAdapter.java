...
public class SocketAdapter {
     ...
     * 
     * @param host is the remote server (without protocol specification)
     ...
     */
    public SocketAdapter(String host, int port, int mode, boolean timeout, ProxyConfig proxyConfig)
    throws IOException {
        ...
        socket = (SocketConnection) Connector.open(uri.toString(), mode, timeout);
    }
    ...
    public SocketAdapter(String host, int port, int mode, boolean timeout) throws IOException {
        this(host, port, mode, timeout, null);
    }
