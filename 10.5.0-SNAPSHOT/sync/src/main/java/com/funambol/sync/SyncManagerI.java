...
public interface SyncManagerI {
    ...
    public void sync(SyncSource src, int syncMode) throws SyncException;
    public void sync(SyncSource src, int syncMode, boolean askServerDevInf) throws SyncException;
