...
public class Updater {
    ...
    /** The updater url */
    private final String UPDATER_REQUEST_URL        = "/sapi/profile/client?action=get-update-info";
            ...
            if(listener != null) {
                if(config.isOptional()) {
                    ...
                    if(!config.isRecommended()) {
                        Log.error("[Updater]Unknown update type: " + 
                                config.getType() + ", assume it is recommended");
                    }
                    Log.info("[Updater]Recommended update is available");
    ...
    private void checkUpdateFromServer() {
        ...
        if (isTimeToRefresh()) {
            ...
            try {
                ...
                Log.info("[Updater] - activationDate: " + config.getActivationDate());
    ...
    private String getUpdaterUrl() {
        ...
        urlParams.append(UPDATER_REQUEST_URL);
