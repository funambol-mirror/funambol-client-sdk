...
public class BlackberryUtils {
     ...
     * @return String the path of the default pictures directory on the SDCard
     */
    public static String getSDCardPicturesdir() {
        String dirPath = System.getProperty("fileconn.dir.memorycard.photos");
        //The following condition applies if the property request fails, usually
        //on OS < 4.3.0
        Log.debug(TAG_LOG, "getSDCARDDir: " + dirPath);
        if (StringUtil.isNullOrEmpty(dirPath)) {
            dirPath = "file:///SDCard/BlackBerry/pictures/";
        }
        return dirPath;
    }
     ...
     * @return String the path of the default pictures directory on the Internal
     * device memory
     */
    public static String getInternalDeviceStorePicturesdir() {
        String dirPath = System.getProperty("fileconn.dir.photos");
        //The following condition applies if the property request fails, usually
        //on OS < 4.3.0
        Log.debug(TAG_LOG, "getInternalDeviceStoredPicturesDir: " + dirPath);
        if (StringUtil.isNullOrEmpty(dirPath)) {

            dirPath = "file:///store/home/user/pictures/";
        }
        return dirPath;
    }
    ...
    public static String getOSVersion() {
        ...
        //The following condition applies if running onto a simulator
