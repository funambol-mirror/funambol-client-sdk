Funambol J2ME Mail API

Version: 6.0.5

OVERVIEW
--------
This library allows to parse/format RFC2822 mail messages in a way similar to
what Javamail does on J2SE, and to store them in the device persistent
storage.
