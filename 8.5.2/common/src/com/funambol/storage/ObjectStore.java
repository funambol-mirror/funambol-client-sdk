...
public class ObjectStore {
    ...
    // ---------------------------------------------- Attributes
    private AbstractRecordStore rs;
     ...
     */
    private synchronized boolean openStore(String name, boolean create)
     ...
     * private method used by open and create to share code.
     */
    private synchronized boolean openStore() throws RecordStoreException  {
        synchronized(mutex) {
            if(name != null) {
