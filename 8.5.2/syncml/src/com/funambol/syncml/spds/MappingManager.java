...
public class MappingManager {
    ...
    public Hashtable getMappings(String sourceName) {
        ...
        try {
            ...
            Log.error(TAG_LOG, "Exception catched reading the mapping stores" + ex);
        }
    ...
    public void saveMappings(Hashtable mappings) {
        ...
        try {
            ...
            Log.error(TAG_LOG, "Exception catched writing the mapping stores" + ex);
        }
    }
    ...
    public void resetMappings(String sourceName) {
        try {
            ...
            Log.error(TAG_LOG, "Cannot reset store " + ioe.toString());
        }
    }
}
