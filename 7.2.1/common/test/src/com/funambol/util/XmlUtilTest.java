 ...
 * Ant too
 */
public class XmlUtilTest extends FunBasicTest {
     ...
     */
    public void testAddElementWithTagAttr() {
     ...
     * com.funambol.util.MailDateFormatter
     */
    public void testAddNewLinetWithTagAttr() {
    ...
    public void test(int testNumber) throws Throwable {
        switch (testNumber) {
            case 0:
                testAddElementWithTagAttr();
                break;
            case 1:
                testAddNewLinetWithTagAttr();
                break;
            default:
                break;
        }
