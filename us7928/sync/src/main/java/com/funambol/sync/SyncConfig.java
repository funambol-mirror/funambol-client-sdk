...
public class SyncConfig {
    ...
    public int[] supportedAuthTypes = { AUTH_TYPE_BASIC,
                                        AUTH_TYPE_MD5 };

    public int preferredAuthType = AUTH_TYPE_BASIC;
    ...
    public boolean allowMD5Authentication() {
        for(int i=0;i<supportedAuthTypes.length;++i) {
            ...
            if (AUTH_TYPE_MD5 == supportedAuthTypes[i]) {
                return true;
            }
        }
        return false;
    ...
    public void setProxyConfig(ProxyConfig newValue) {
        proxyConfig = newValue;
    }
