...
//#         if (PersistentStoreManager.exists( recordStoreName )) {
//#             if (!isStoreLoaded( recordStoreName )) {
//#                 store = new BlackberryRecordStore( recordStoreName,
//#                         (IntHashtable) PersistentStoreManager.getObject( recordStoreName ) );
//#                 RuntimeStore.getRuntimeStore().put( recordStoreName.hashCode(), store );
//#             }
//#             else {
//#                 store = (BlackberryRecordStore) RuntimeStore.getRuntimeStore().get( recordStoreName.hashCode() );
//# 
...
//#     
//#     /**
//#      * Determines if the named store is loaded in the RuntimeStore
...
//#         getRecords().put( 0, new Integer(getNextRecordID() + 1) );
...
//#         // 3) >1 item: size it number of items - 1
//#         if (size <= 1) {
//#             return 0;
//#         } else {
//#             return --size;
...
//# 
//#         if (!isValidRecordId( recordId )) {
//#             throw new InvalidRecordIDException( "exception encountered while getting recordId: " + recordId );
//#         }
//# 
...
//#         ensureOpen();
//#         //        if (!isValidRecordId( recordId )) {
//#         //            throw new InvalidRecordIDException( "Record with id: " + recordId + " not found in store: " + getName() );
//#         //        }
//# 
...
//#         return getRecords().containsKey( recordId );
//# 
//#     }
//# 
...
//#             ObjectWrapper object = (ObjectWrapper) PersistentStore.getPersistentObject( persistentStoreKey ).getContents();
//#             if (object == null) {
...
//#             po.setContents( new ObjectWrapper( o ) );
//#             po.commit();
//# 
//#         }
//# 
