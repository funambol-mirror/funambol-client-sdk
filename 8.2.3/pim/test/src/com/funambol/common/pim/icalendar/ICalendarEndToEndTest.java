...
/**
 * This is a ent-to-end test for the iCalendar parsing/formatting process.
...
public class ICalendarEndToEndTest extends TestCase {
    ...
    public void endToEndTest() throws Throwable {
        ...
        String ical;
        do {
            ical = ICalendarTestUtils.getNextICalendarItem(eventsStream);
            if (ical.length() > 0) {
        ...
        do {
            ical = ICalendarTestUtils.getNextICalendarItem(todosStream);
            if (ical.length() > 0) {
    ...
    public void singleICalTest(String originalIcal, PIMItem pimItem) throws Throwable {
        ...
        ICalendarSyntaxParserListener lis = new CalendarParserListener(pimItem);
        ...
        formatter.format(pimItem, ostream);
