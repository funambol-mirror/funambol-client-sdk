...
public class SyncMLFormatter {
     ...
     * @param username the username to be used as LocName in the source tag
    ...
    public String formatSyncHeader(String sessionid,
        ...
        ret.append("<SyncHdr>\n").append("<VerDTD>1.2</VerDTD>\n")
           ...
           .append("<Target>")
           .append("<LocURI>").append(tgt).append("</LocURI>")
           .append("</Target>\n")
           .append("<Source>")
     ...
     */
    public String formatSyncHdrStatus(String cmdId, int msgIdRef,
                                      String deviceId, String serverUrl) {
     ...
     * @return the SyncML status
     */
    public String formatAlertStatus(String cmdId, int msgRef, int cmdRef,
                                    String sourceRef, String targetRef,
                                    long nextAnchor, int statusCode) {
        ...
        status.append("<Status>\n")
              ...
              .append("<TargetRef>").append(targetRef).append("</TargetRef>\n")
              .append("<SourceRef>").append(sourceRef).append("</SourceRef>\n")
              .append("<Data>").append(statusCode).append("</Data>\n")
              .append("<Item>\n").append("<Data>\n")
     ...
     * @param b64Login the authentication token
     * @param md5 true if the token is for md5 authentication
   ...
   public String formatEndSyncML() {
     ...
     */
    public String formatPutDeviceInfo(String cmdId, DeviceConfig devInf,
   ...
   public String formatEndSync() {
     ...
     *         message sent to the server
     */
    private String createDevInf(DeviceConfig devInf, String sourceName, String sourceType) {
        StringBuffer sb = new StringBuffer();
