...
public class MIMEProcessorTest extends TestCase {
     ...
     */
    public MIMEProcessorTest(String name) {
        super(name);
     ...
     * 
     */
    public void testparseRFC2822() throws Exception {

        Log.info("MIMEProcessorTest: testparseRFC2822");
        ...
        assertEquals("Content", SampleMessage.RFC2822_CONTENT, (String)m.getContent());

        Log.info("MIMEProcessorTest: testparseRFC2822 successful");
    }
     ...
     */
    public void testparseRFC2822ByChunkedString() throws Exception {

        Log.info("MIMEProcessorTest: testparseRFC2822ByChunkedString");
        ...
        Log.info("MIMEProcessorTest: testparseRFC2822ByChunkedString successful");
    }
     ...
     * 
     */
    public void testparseTHUNDERBIRD() throws Exception {
        
        Log.info("MIMEProcessorTest: testparseTHUNDERBIRD");
        ...
        assertEquals("Content", SampleMessage.THUNDERBIRD_CONTENT, (String)m.getContent());

        Log.info("MIMEProcessorTest: testparseTHUNDERBIRD successful");
    }
     ...
     * wrapping with a chunkedstring object
     */
    public void testparseTHUNDERBIRDByChunkedString() throws Exception {

        Log.info("MIMEProcessorTest: testparseTHUNDERBIRDByChunkedString");
        ...
        Log.info("MIMEProcessorTest: testparseTHUNDERBIRDByChunkedString successful");
    }
}
