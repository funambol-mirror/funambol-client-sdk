...
public class FolderTest extends TestCase {
    ...
    /**
     * Test of getMessages method, of class com.funambol.mail.Folder.
     */
    public void testgetMessages() throws Exception {
        Log.info("FolderTest: testgetMessages");
        Message m = createNoLazyMessage();
        folder.appendMessage(m);
        
        Message[] result = folder.getMessages();
        
        assertTrue(compareMessages(m, result[0]));
        Log.info("FolderTest: testgetMessages successful");
    }
    ...
    public void testgetFirstMessage() throws Exception {
        Log.info("FolderTest: testgetFirstMessage");
        int msgNumber = 3;
        ...
        resultMessages[0] = folder.getFirstMessage();
        
        assertTrue(resultMessages[0].getRecordId()>0);
        Log.info("FolderTest: testgetFirstMessage successful");
    }
    ...
    public void testgetNextMessage() throws Exception {
        Log.info("FolderTest: testgetNextMessage");
        int msgNumber = 3;
        Message[] messages = createMultipleNoLazyMessages(3);
        for (int i=0; i<messages.length; i++) {
            folder.appendMessage(messages[i]);
        ...
        for (int i=0; i<resultMessages.length; i++) {
            resultMessages[i] = folder.getMessage(String.valueOf(i+1));
        ...
        assertTrue(result);
        Log.info("FolderTest: testgetNextMessage successful");
    }
     ...
     * Test of deleteMessage method, of class com.funambol.mail.Folder.
     */
    public void testdeleteMessageByIndex() throws Exception {
        Log.info("FolderTest: testdeleteMessageByIndex");
        int msgNumber = 3;
        Message[] messages = createMultipleNoLazyMessages(3);
        ...
        assertEquals(msgNumber-1, folder.getMessageCount());
        Log.info("FolderTest: testdeleteMessageByIndex successful");
    }
    ...
    public void testgetStore() throws Exception {
        Log.info("FolderTest: testgetStore");
        Store store1 = folder.getStore();
        assertEquals(store, store1);
        Log.info("FolderTest: testgetStore successful");
    }
    ...
    public void testgetFolder() throws Exception {
        Log.info("FolderTest: testgetFolder");
        
        store.addFolder(new Folder(FOLDER_FULLNAME + "/newFolder", "inbox", new Date(), store));
        //fix the method name: returns subfolders
        Folder f1 = folder.getFolder("newFolder");
        
        assertEquals(FOLDER_FULLNAME + "/newFolder", f1.getFullName());
        store.removeFolder(store.getFolder(FOLDER_FULLNAME + "/newFolder"), false);
        Log.info("FolderTest: testgetFolder successful");
    }
    ...
    public void testserialize() throws Exception { 
        ...
        Folder folder = new Folder("/Parent/Children", "inbox", new Date(1240907915), this.folder.getStore());
        store.addFolder(new Folder("/Parent", "inbox", new Date(), store));
        Folder parent = store.getFolder("/Parent");
