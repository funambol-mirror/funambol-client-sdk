...
public final class HttpTransportAgent implements TransportAgent {
    ...
    public HttpTransportAgent(String requestURL,
        ...
        Log.info(TAG_LOG, "Number of writing Attempts: " + this.retryOnWrite);
        this.userAgent = userAgent;
        Log.info(TAG_LOG, "UserAgent set to: " + this.userAgent);
        this.requestURL = requestURL;
        Log.info(TAG_LOG, "Request Url set to: " + this.requestURL);
        this.charset = charset;
        Log.info(TAG_LOG, "Charset set to: " + this.charset);
        this.sizeThreshold = 0;
        Log.info(TAG_LOG, "Threshold size set to: " + this.sizeThreshold);
        this.enableCompression = compress;
        Log.info(TAG_LOG, "enableCompression: " + enableCompression);
        this.responseDate = null;
        Log.info(TAG_LOG, "responseDate: " + this.responseDate);
...
//#endif
        ...
        /*
         * Use the connectionManager instance to open up the connection with
         * timeout parameter set to false, but some devices (eg. nokia S40,
         * Samsung, SE) ignore this parameter, and the connection is opened with
         * a timeout anyway.
         *
         */
        c = (HttpConnection) connectionManager.open(requestURL, Connector.READ_WRITE, false);
        ...
        Log.debug("[HttpTransportAgent.openConnection]: Programming alarm in " + connTimer.getDelay() + " msec");
