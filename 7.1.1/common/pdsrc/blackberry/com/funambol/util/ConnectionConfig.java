...
public class ConnectionConfig {
    ...
    private static void init() {
        ...
        ///////////////////////////////////////////////////////
        configurations[SERVICE_BOOK_CONFIG].setUrlParameters(BASE_CONFIG_PARAMETERS + BlackberryUtils.getServiceBookOptions());
    ...
    public static boolean isUserConfirmationNeeded() {
        Log.debug("[ConnectionManager.isUserConfirmationNeeded]User Confirmation needed value is: " + !ConnectionConfig.isUSCarrier());
        return !isUSCarrier();
    }
    ...
    public static void removeSavedConfig() {
        Log.debug("[ConnectionManager.removeSavedConfig]Removing saved config (" + ConnectionManager.workingConfigID + ") " + getWorkingConfigurationDescription());
