...
MediaSapiSyncSource::MediaSapiSyncSource(SyncSourceConfig& sc, SyncSourceReport& rep, size_t incomingFilterDate, size_t outgoingFilterDate, const char* storageLocation) 
        : FileSapiSyncSource(sc, rep, incomingFilterDate, outgoingFilterDate, storageLocation) {
