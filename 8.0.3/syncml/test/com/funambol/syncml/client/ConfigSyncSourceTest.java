...
public class ConfigSyncSourceTest extends FunBasicTest {
    ...
    public ConfigSyncSourceTest() throws Exception {
        super(2, "ConfigSyncSourceTest");
    ...
    private void testFastSync1() throws Throwable {
