...
public abstract class ChangesTrackerTest extends FunBasicTest {
    ...
    public ChangesTrackerTest(int extraTests, String name) throws Exception {

        super(NUM_TESTS + extraTests, name);
    ...
    protected void extraTest(int testNumber) throws Throwable {
    }
    ...
    public void test(int testNumber) throws Throwable {
        ...
        switch(testNumber) {
            ...
            case 1:
                ...
                break;
            case 2:
                testChangesDuringSync1();
                break;
            default:
                extraTest(testNumber - NUM_TESTS);
                break;
        }
    }
    ...
    private void testSimpleFasts() throws Exception {
    ...
    private void testReceivedNewItems() throws Exception {
        ...
        source.addItem(item);
        // Now check that there are no new items reported
    ...
    private void testSlowSync1() throws Exception {
    ...
    private void testChangesDuringSync1() throws Exception {
