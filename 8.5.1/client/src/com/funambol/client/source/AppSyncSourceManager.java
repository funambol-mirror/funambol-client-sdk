...
public class AppSyncSourceManager {
    ...
    public static final long    CONTACT_STORAGE_KEY       = 0xbc565a75eda5330L;
    public static final long    CALENDAR_STORAGE_KEY      = 0xbc565a75eda5340L;
    public static final long    NOTE_STOREAGE_KEY         = 0xbc565a75eda5350L;
    public static final long    TASK_STORAGE_KEY          = 0xbc565a75eda5360L;
    public static final long    PHOTO_STORAGE_KEY         = 0xbc565a75eda5380L;
    public static final long    CONFIG_STORAGE_KEY        = 0xbc565a75eda53A0L;

    public static final long    CONTACTS_ADDITS_STORAGE_KEY = 0xbc565a75eda5390L;
    public static final long    CALENDAR_ADDITS_STORAGE_KEY = 0xbc565a75eda5370L;
    public static final long    NOTE_ADDITS_STORAGE_KEY     = -1;
    public static final long    TASKS_ADDITS_STORAGE_KEY    = -1;

    // Configuration keys for the source configs
    ...
    private static final String  NOTE_TYPE                 = NOTE_TYPE_SIF;
    private static final String  PHOTO_TYPE                = SourceConfig.FILE_OBJECT_TYPE;
    private static final String  CONFIG_TYPE               = SourceConfig.BRIEFCASE_TYPE;
    ...
    public class SortedSourcesEnumeration implements Enumeration {
        ...
        private void bubbleSortResult() {
            ...
            for (int i = 0; i < sources.size(); i++) {
                result.add(sources.elementAt(i));
            }
