...
class DeviceManagementNode: public ManagementNode {
    ...
    public:
        ...
        /**
         * Constructor, with the full node path.
         * If the path passed contains a slash "/" char that needs to be kept,
         * the caller MUST escape it with a double slash "//" before calling this meythod.
         * Otherwise it would be converted into a backslash "\" and a new leaf will
         * be created.
         *
         * @param fullName - the the full node path
         */
        ...
        /**
        * Implementation of the method to read all the extra properties
        */
        StringMap* readAllProperties();
         ...
         */
        int deleteProperty(const char* keyName);
};
