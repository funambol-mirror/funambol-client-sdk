 ...
 * communication bus, registered through the registerMessageHandler method.
 */
public abstract class BusMessageHandler {
     ...
     * @param message
     */
    public abstract void receiveMessage(BusMessage message);
