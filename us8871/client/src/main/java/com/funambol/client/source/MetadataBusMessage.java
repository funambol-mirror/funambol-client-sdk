...
public class MetadataBusMessage extends BusMessage {

    private static final String TAG_LOG = "MetadataBusMessage";
    ...
    public MetadataBusMessage(AppSyncSource source, int action, Object message) {
        super(message);
        this.action = action;
        this.source = source;
    }
