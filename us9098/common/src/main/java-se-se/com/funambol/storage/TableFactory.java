...
public class TableFactory {
    ...
    public Table getStringTable(String name, int colsType[], int keyIdx) {
        if (directory == null) {
            Log.error(TAG_LOG, "Cannot create string table until the TableFactory is properly initialized");
            return null;
        }
        // On SE the default key value store in a file store
        return new FileTable(directory, name, colsType, keyIdx);
    }
    ...
    public Table getStringTable(String name, String colsName[], int colsType[], int keyIdx) {
        ...
        // On SE the default key value store in a file store
        return new FileTable(directory, name, colsName, colsType, keyIdx);
    }
    ...
    public Table getStringTable(String name, int colsType[], int keyIdx, boolean autoincrement) {
        ...
        // On SE the default key value store in a file store
        return new FileTable(directory, name, colsType, keyIdx, autoincrement);
    }
    ...
    public Table getStringTable(String name, String colsName[], int colsType[], int keyIdx, boolean autoincrement) {
        ...
        // On SE the default key value store in a file store
        return new FileTable(directory, name, colsName, colsType, keyIdx, autoincrement);
    }
