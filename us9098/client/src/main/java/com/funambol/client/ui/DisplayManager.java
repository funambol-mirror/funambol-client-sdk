...
public interface DisplayManager {
     ...
     */
    public int askYesNoQuestion(Screen screen, String question, Runnable yesAction,
     ...
     */
    public int promptSelection(Screen screen, String question, DialogOption[] options,
                               int defaultValue);
    ...
    public int promptMultipleSelection(Screen screen, String title,
            ...
            MultipleSelectionClickListener listener);
    
    public interface MultipleSelectionClickListener {
        public void onPositiveButtonClick();
        public void onNegativeButtonClick();
        public void onSelectionClick(int whichButton, boolean isChecked);
    }
