...
public class SyncSettingsScreenController {
    ...
    public SyncSettingsScreenController(Controller controller, Customization customization,
    ...
    private void computeVisibleItems() {
        ...
        if(sourceSettingsUIItems == null) {
            ...
            if(customization.showC2SPushInSettingsScreen() && !pushModeEnabled) {
            ...
            while (sources.hasMoreElements()) {
                ...
                if (controller.isVisible(appSource) && appSource.hasSettings()) {
                    ...
                    // working and active
                    if (!appSource.getConfig().getActive() || !appSource.isWorking() || !appSource.getConfig().getAllowed()) {
