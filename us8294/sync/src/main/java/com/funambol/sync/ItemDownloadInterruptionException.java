...
public class ItemDownloadInterruptionException extends SyncException {
    ...
    public ItemDownloadInterruptionException(SyncItem item, long actualSize) {
        this(SyncException.READ_SERVER_RESPONSE_ERROR, item, actualSize);
    }

    public ItemDownloadInterruptionException(int code, SyncItem item, long actualSize) {
        super(code, "Cannot download item");
        this.item = item;
