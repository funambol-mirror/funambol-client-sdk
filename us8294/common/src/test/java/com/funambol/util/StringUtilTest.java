...
public class StringUtilTest extends TestCase {
    ...
    public void testLastIndexOf() throws Exception {
        String str = "/home/user/synclog.txt";
        assertTrue(StringUtil.lastIndexOf(str,'/') == 10);
        assertTrue(StringUtil.lastIndexOf(str,'$') == -1);

        str = "/home/user/";
        assertTrue(StringUtil.lastIndexOf(str,'/') == 10);

        str = "/";
        assertTrue(StringUtil.lastIndexOf(str,'/') == 0);
    }
}
