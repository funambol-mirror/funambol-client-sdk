...
public abstract class StringKeyValueStoreTest extends TestCase {
    ...
    public void testSaveLoad() throws Exception  {
        ...
        store.add("key-0", "value-0");
        store.add("key-1", "value-1");
        store.save();
    ...
    public void testUpdate1() throws Exception {
        ...
        store.add("key-0", "value-0");
        store.update("key-0", "value-1");
 
        assertTrue(store.contains("key-0"));
        assertTrue("value-1".equals(store.get("key-0")));
    }

    public void testUpdate2() throws Exception {
        StringKeyValueStore store = createStore("Test_update2");
        ...
        StringKeyValueStore store2 = createStore("Test_update2");
        store2.load();
        String value0 = store2.get("key-0");
        assertTrue("value-1".equals(value0));
    }
    ...
    public void testRemove2() throws Exception  {
        StringKeyValueStore store = createStore("Test_remove2");

        String value1 = "value-1";

        store.add("key-0", "value-0");
        store.add("key-1", value1);
        ...
        StringKeyValueStore store2 = createStore("Test_remove2");
        store2.load();
        String v0 = store2.get("key-0");
        String v1 = store2.get("key-1");
        assertTrue(v0 == null);
        assertTrue(value1.equals(v1));
    }

    public void testReset1() throws Exception  {
        StringKeyValueStore store = createStore("Test_reset1");

        String value0 = "value-0";
        String value1 = "value-1";

        store.add("key-0", value0);
        store.add("key-1", value1);
        ...
        StringKeyValueStore store2 = createStore("Test_reset1");
        store2.load();
        String v0 = store2.get("key-0");
        String v1 = store2.get("key-1");
        assertTrue(v0 == null);
