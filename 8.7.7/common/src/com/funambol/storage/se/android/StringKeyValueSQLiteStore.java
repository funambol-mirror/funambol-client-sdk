...
public class StringKeyValueSQLiteStore implements StringKeyValueStore {
    ...
    public StringKeyValueSQLiteStore(Context c, String dbName, String tableName) {
        ...
        // already)
        open();
        dbStore.execSQL("CREATE TABLE IF NOT EXISTS " + tableName + " ("
    ...
    public void update(String key, String value) {
        ...
        if(dbStore.update(tableName, cv, KEY_COLUMN_NAME + "=" + intkey, null) != -1) {
    ...
    public String get(String key) {
        ...
        Cursor resultCursor = dbStore.query(true, tableName, QUERY_VALUE_COLUMN,
                KEY_COLUMN_NAME + "=" + intkey, null, null, null, null, null);
    ...
    public String remove(String key) {
        ...
        dbStore.delete(tableName, KEY_COLUMN_NAME + "=" + intkey, null);
        return null;
    }
