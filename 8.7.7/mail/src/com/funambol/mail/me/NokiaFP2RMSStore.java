...
import com.funambol.storage.NonClosingObjectStore;
...
/**
 * Extends the <code>RMSStore</code> class using an ObjectStore fixed for Nokia
 ...
 */
public class NokiaFP2RMSStore extends RMSStore {
    ...
    protected ObjectStore createObjectStore() {
        return new NonClosingObjectStore();
    }

    protected ObjectStore createObjectStore(String name) {
        return new NonClosingObjectStore(name);
    }
}
