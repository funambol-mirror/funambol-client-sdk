...
class DMTClientConfig : public SyncManagerConfig {
    ...
    protected:
        ...
        virtual bool readSapiConfig(ManagementNode& n);
        virtual void saveSapiConfig(ManagementNode& n);
        ...
        /**
         * Called by readSapiConfig() to save SAPI media sync
         * settings.  The purpose of making this function virtual is
         * that a derived class can override it and then to read the
         * settings from a different than the default
         * "spds/syncml/Sapi" node by calling the base function with a
         * different \a sapiNode parameter or generate the settings in
         * some other way.
         *
         * @param syncMLNode     the "spds/syncml" node
         * @param sapiNode       the "spds/syncml/Sapi" node
         */
        virtual bool readSapiConfig(ManagementNode& syncMLNode,
                                    ManagementNode& sapiNode);

        /**
         * Same as readSapiConfig() for saving the settings.
         *
         * @param syncMLNode     the "spds/syncml" node
         * @param sapiNode       the "spds/syncml/Sapi" node
         */
        virtual void saveSapiConfig(ManagementNode& syncMLNode,
                                    ManagementNode& sapiNode);
