 ...
 */
public class NamedObjectStorePerfTest extends FunBasicTest {
    ...
    public NamedObjectStorePerfTest() {
        super(2, "NamedObjectStorePerfTest");
    ...
    public void test(int testNumber) throws Throwable {
        ...
        switch(testNumber) {
            case 0: testRetrieveOne();     break;
            case 1: testRetrieveAll();     break;
            default:                       break;
        }
    }
     ...
     */
    private void testRetrieveOne() throws Exception {
