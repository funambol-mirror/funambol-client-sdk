 ...
 */
public class RMSStoreTest extends FunBasicTest {
     ...
     */
    private void testCreateFolder() throws Exception {
     ...
     */
    private void testRemoveFolder() throws Exception {
     ...
     * @throws Exception when the test fails
     */
    private void testInitDoReset() throws Exception {
     ...
     */
    private void testGetFolder() throws Exception {
     ...
     */
    private void testfindFolders() throws Exception {
     ...
     */
    private void testaddMessage() throws Exception {
     ...
     */
    private void testsaveMessage() throws Exception {
     ...
     */
    private void testremoveMessage() throws Exception {
     ...
     */
    private void testcountMessages() throws Exception {
     ...
     */
    private void testgetMessageIDs() throws Exception {
     ...
     */
    private void testgetMsgHeaders() throws Exception {
     ...
     */
    private void testreadMessageByPath() throws IOException, Exception {
     ...
     */
    public void testreadMessageByStream() throws Exception, IOException {
     ...
     * "readNextMessage".
     */
    private void testreadFirstMessage() throws Exception {
     ...
     */
    private void testreadNextMessage() throws Exception {
