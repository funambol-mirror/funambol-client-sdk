...
public class VCardParserTest extends FunBasicTest {
    ...
    public VCardParserTest() {
        super(2, "VCardParserTest");
    ...
    private void testVCard1() throws Throwable {
        ...
        ContactParserListener lis = new ContactParserListener(contact);
    ...
    private void testParserBlindly() throws Throwable {

        InputStream vcardsStream = getClass().getResourceAsStream("/res/vcards.txt");
        String vcard;
        int total = 0;
