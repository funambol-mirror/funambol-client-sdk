...
public class Message extends Part implements Serializable {
    ...
    public void reloadMessage() throws MailException {
        ...
        if (parent != null) {
            try {
                ...
                DataInputStream is = store.readMessage(this);
                deserialize(is);
    ...
    /**
     * Set record id. The record id is the position of the message in the store
     * where the message is kept. This information is meaningful for Stores that
     * have concept of position and maybe un-initialized in other cases.
     * This information is set by the API and cannot be modified by outside the
     * API.
     *
     * @param recordId the message position in the store
     */
    ...
    public String createUniqueMessageIDValue() {
        ...
        s.append(System.currentTimeMillis()).append(r.nextInt()).append(
                "@Funambol.mail");
