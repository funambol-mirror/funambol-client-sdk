 ...
 */
public class LazyMessageTest extends FunBasicTest {
     ...
     */
    private void testaddLazyHeadersMessage() throws Exception {
     ...
     * Add message to the store: retrieves it by folder and test the addition
     */
    private void testaddLazyContentMessage() throws Exception {
     ...
     * Add message to the store: retrieves it by folder and test the addition
     */
    private void testaddFullLazyMessage() throws Exception {
     ...
     */
    private void testsaveLazyHeadersMessage() throws Exception {
     ...
     * Retrieves the correctly updated message
     */
    private void testsaveLazyContentMessage() throws Exception {
     ...
     * Retrieves the correctly updated message
     */
    private void testsaveFullLazyMessage() throws Exception {
     ...
     */
    private void testgetLazyHeadersMsgHeaders() throws Exception {
     ...
     * Read all Headers of INBOX messages
     */
    private void testgetLazyContentMsgHeaders() throws Exception {
     ...
     * Read all Headers of INBOX messages
     */
    private void testgetFullLazyMsgHeaders() throws Exception {
     ...
     */
    private void testreadLazyHeadersByMessageByPath() throws Exception {
     ...
     * Read a message passing the path of the inbox folder
     */
    private void testreadLazyContentByMessageByPath() throws Exception {
     ...
     * Read a message passing the path of the inbox folder
     */
    private void testreadFullLazyByMessageByPath() throws Exception {
