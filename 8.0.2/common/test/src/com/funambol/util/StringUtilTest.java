...
public class StringUtilTest extends FunBasicTest {
    ...
    private void testExtractAddress(){
        ...
        res = StringUtil.extractAddressFromUrl("https://pv.funambol.com/sync");
        assertEquals("https://pv.funambol.com", res);

        res = StringUtil.extractAddressFromUrl("https://pv.funambol.com:8080/sync");
        assertEquals("https://pv.funambol.com:8080", res);

        res = StringUtil.extractAddressFromUrl("https://pv.funambol.com");
        assertEquals("https://pv.funambol.com", res);
    }
    ...
    private void testGetProtocolFromUrl() {
        String url = "http://my.funambol.com:8080/sync";
