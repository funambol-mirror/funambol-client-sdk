...
#ifndef INCL_FSYNCSOURCELISTENER
#define INCL_FSYNCSOURCELISTENER
...
/**
 * This class extends the SyncSourceListener in order to be notified of the 
 * SyncSourceEvents. It simply displays the sync messages on the shell.
 */
