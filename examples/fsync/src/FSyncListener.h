...
#ifndef INCL_FSYNCLISTENER
#define INCL_FSYNCLISTENER
...
/**
 * This class extends the SyncListener in order to be notified of the 
 * SyncEvents. It simply displays the sync messages on the shell.
 */
