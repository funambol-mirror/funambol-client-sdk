...
#ifndef INCL_FSYNCTRANSPORTLISTENER
#define INCL_FSYNCTRANSPORTLISTENER
...
/**
 * This class extends the TransportListener in order to be notified of the 
 * TransportEvents. It displays dots while sending/receiving files
 */
class FSyncTransportListener : public TransportListener
{
    public:
  
        FSyncTransportListener();
        ~FSyncTransportListener();
