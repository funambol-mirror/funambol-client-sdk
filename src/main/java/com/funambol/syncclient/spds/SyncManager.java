 ...
 *
 * @version  $Id: SyncManager.java,v 1.3 2007-12-22 18:09:17 nichele Exp $
 */
public class SyncManager implements SyncTransportListener {
    ...
    private void exchangeModifications() throws SyncException {
        ...
        do {
            ...
            // We should now interpret the server responses,
            // since they contain statuses for the server.
