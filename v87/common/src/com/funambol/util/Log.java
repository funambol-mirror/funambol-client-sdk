...
public class Log {
    ...
    private static void cacheMessage(int msgLevel, String levelMsg, String msg) throws DataAccessException {
    ...
    private static void dumpAndFlushCache() throws DataAccessException {
