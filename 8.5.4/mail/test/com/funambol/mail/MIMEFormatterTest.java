...
public class MIMEFormatterTest extends TestCase {
     ...
     */
    public MIMEFormatterTest(String name) {
        super(name);
    ...
    public void testFormat() throws Exception {
        Log.info("MIMEFormatterTest: testFormat");
        try {
        ...
        Log.info("MIMEFormatterTest: testFormat successful");
    }
     ...
     * @throws Exception
     */
    public void testFormatB64WithCTE() throws Exception {
        Log.info("MIMEFormatterTest: testFormatB64WithCTE");
        try {
            String to = "monty@funambol.com";
            String from = "giuseppe.monticelli@gmail.com";
            String subject = "An experiment with the SyncML";
        ...
        Log.info("MIMEFormatterTest: testFormatB64WithCTE successful");
    }

    public void testFormatB64WithoutCTE() throws Exception {
        Log.info("MIMEFormatterTest: testFormatB64WithoutCTE");
        try {
            String to = "monty@funambol.com";
            String from = "giuseppe.monticelli@gmail.com";
            String subject = "An experiment with the SyncML";
        ...
        Log.info("MIMEFormatterTest: testFormatB64WithoutCTE successful");
    }
}
