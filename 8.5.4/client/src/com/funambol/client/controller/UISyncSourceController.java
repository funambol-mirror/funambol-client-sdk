...
public class UISyncSourceController implements SyncListener {
    ...
    public UISyncSourceController(Customization customization, Localization localization,
        ...
        animation = new SyncingAnimation();
    }
    ...
    private class SyncingAnimation {

        final private Bitmap[] bitmaps = customization.getStatusIconsForAnimation();

        private int currentFrame;
        private int currentIndex;
        Thread anim;

        public SyncingAnimation() {
        }
        ...
        private void runAnimation() {
            ...
            try {
                while (true) {
                    ...
                    uiSource.setStatusIcon(bitmaps[currentFrame]);
                    uiSource.redraw();
                ...
                uiSource.setStatusIcon(bitmaps[0]);
                // Force a repaint
                return;
            }
